...
sap.ui.define([
    ...
    Validator.prototype.isValid = function () {
	  ...
	  Validator.prototype.get_error_fields = function () {
		  var error_fields = this._error_fields;
    ...
    Validator.prototype.validate = function (oControl) {
        ...
        return this.get_error_fields();
		
    };
	
	 Validator.prototype.get_All_fields = function () {
		  var AllFields = this.AllFields;
		 //delete this._error_fields;
		  //this._error_fields = [];
		 // console.log("454757");
        return AllFields;
    };
	
	 Validator.prototype.AllField = function (oControl) {
		 
		 this._isValid = true;
        sap.ui.getCore().getMessageManager().removeAllMessages();
        this.AllField(oControl);
        return this.get_All_fields();
		
    };
	 Validator.prototype.AllField = function (oControl) {
		 			
        var aPossibleAggregations = ["cells","items", "content", "form", "formContainers", "formElements", "fields"],
            ...
            if (oControl.getVisible()) {
				...
				console.log(oControl);
                    if (oControl.getBinding(aValidateProperties[i])) {
							//console.log(oControl.getBinding(aValidateProperties[i]));
...
/*                                oControlBinding = oControl.getBinding(aValidateProperties[i]);
								...
								sap.ui.getCore().getMessageManager().addMessages(error_message);*/
								this.AllFields.push(oControl.getId());	
                            }
...
/*                                oControlBinding = oControl.getBinding(aValidateProperties[i]);
								...
								sap.ui.getCore().getMessageManager().addMessages(error_message);*/
								this._error_fields.push(oControl.getId());	
                            }
